...
import sun.jvm.hotspot.utilities.soql.JSMetadata;
...
public abstract class JSJavaScriptEngine extends MapScriptObject {
    ...
    */
    public Object address(Object[] args) {
        ...
        Object o = args[0];
        if (o != null && o instanceof sun.jvm.hotspot.utilities.soql.JSJavaObject) {
            return ((sun.jvm.hotspot.utilities.soql.JSJavaObject)o).getOop().getHandle().toString();
        } else {
            return UNDEFINED;
        }
    }
    ...
    */
    public Object classof(Object[] args) {
        ...
        Object o = args[0];
        if (o != null) {
            if (o instanceof sun.jvm.hotspot.utilities.soql.JSJavaObject) {
                if (o instanceof sun.jvm.hotspot.utilities.soql.JSJavaInstance) {
                    return ((JSJavaInstance)o).getJSJavaClass();
                } else if (o instanceof sun.jvm.hotspot.utilities.soql.JSJavaArray) {
    ...
    */
    public Object dumpClass(Object[] args) {
      ...
      if (clazz == null) {
        ...
        } else if (clazz instanceof sun.jvm.hotspot.utilities.soql.JSJavaClass) {
            sun.jvm.hotspot.utilities.soql.JSJavaKlass jk = ((sun.jvm.hotspot.utilities.soql.JSJavaClass)clazz).getJSJavaKlass();
    ...
    */
    public Object identityHash(Object[] args) {
        ...
        Object o = args[0];
        if (o != null && o instanceof sun.jvm.hotspot.utilities.soql.JSJavaObject) {
            return new Long(((sun.jvm.hotspot.utilities.soql.JSJavaObject)o).getOop().identityHash());
        } else {
            return UNDEFINED;
        }
    }
    ...
    */
    public Object mirror(Object[] args) {
        ...
        if (o != null) {
            if (o instanceof sun.jvm.hotspot.utilities.soql.JSJavaObject) {
            Oop oop = ((sun.jvm.hotspot.utilities.soql.JSJavaObject)o).getOop();
            try {
                    res = getObjectReader().readObject(oop);
                } catch (Exception e) {
                    if (debug) e.printStackTrace(getErrorStream());
                }
            } else if (o instanceof sun.jvm.hotspot.utilities.soql.JSMetadata) {
    ...
    */
    public Object owner(Object[] args) {
        Object o = args[0];
        if (o != null && o instanceof sun.jvm.hotspot.utilities.soql.JSJavaObject) {
            return getOwningThread((sun.jvm.hotspot.utilities.soql.JSJavaObject)o);
        } else {
            return UNDEFINED;
        }
    }
    ...
    */
    public Object sizeof(Object[] args) {
        ...
        Object o = args[0];
        if (o != null && o instanceof sun.jvm.hotspot.utilities.soql.JSJavaObject) {
            return new Long(((sun.jvm.hotspot.utilities.soql.JSJavaObject)o).getOop().getObjectSize());
        } else {
            return UNDEFINED;
        }
    }
    ...
    */
    public Object staticof(Object[] args) {
        ...
        InstanceKlass ik = null;
        if (classname instanceof sun.jvm.hotspot.utilities.soql.JSJavaClass) {
            sun.jvm.hotspot.utilities.soql.JSJavaClass jclass = (JSJavaClass) classname;
        ...
        sun.jvm.hotspot.utilities.soql.JSJavaFactory factory = getJSJavaFactory();
        try {
    ...
    */
    ...
    protected void start(boolean console) {
      ...
      sun.jvm.hotspot.utilities.soql.JSJavaFactory fac = getJSJavaFactory();
    ...
    private sun.jvm.hotspot.utilities.soql.JSJavaThread getOwningThread(JSJavaObject jo) {
        Oop oop = jo.getOop();
        Mark mark = oop.getMark();
        ObjectMonitor mon = null;
      Address owner = null;
        sun.jvm.hotspot.utilities.soql.JSJavaThread owningThread = null;
