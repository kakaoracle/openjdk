...
public class ConstMethod extends VMObject {
  ...
  private static synchronized void initialize(TypeDataBase db) throws WrongTypeException {
    ...
    constMethodSize            = new sun.jvm.hotspot.oops.CIntField(type.getCIntegerField("_constMethod_size"), 0);
    flags                      = new sun.jvm.hotspot.oops.CIntField(type.getCIntegerField("_flags"), 0);
    ...
    codeSize                   = new sun.jvm.hotspot.oops.CIntField(type.getCIntegerField("_code_size"), 0);
    nameIndex                  = new sun.jvm.hotspot.oops.CIntField(type.getCIntegerField("_name_index"), 0);
    signatureIndex             = new sun.jvm.hotspot.oops.CIntField(type.getCIntegerField("_signature_index"), 0);
    idnum                      = new sun.jvm.hotspot.oops.CIntField(type.getCIntegerField("_method_idnum"), 0);
    maxStack                   = new sun.jvm.hotspot.oops.CIntField(type.getCIntegerField("_max_stack"), 0);
    maxLocals                  = new sun.jvm.hotspot.oops.CIntField(type.getCIntegerField("_max_locals"), 0);
    sizeOfParameters           = new sun.jvm.hotspot.oops.CIntField(type.getCIntegerField("_size_of_parameters"), 0);
