...
public abstract class ProfileData {
  ...
  public sun.jvm.hotspot.oops.DataLayout data() { return _data; }
  ...
  public int sizeInBytes() {
    return sun.jvm.hotspot.oops.DataLayout.computeSizeInBytes(cellCount());
  }
  ...
  public static int cellOffset(int index) {
    return sun.jvm.hotspot.oops.DataLayout.cellOffset(index);
  }
