...
package hotspot.agent.src.share.classes.sun.jvm.hotspot.debugger.dummy;
...
public class DummyDebugger extends DebuggerBase {
  ...
  public Address parseAddress(String addrStr) {
    ...
    return new sun.jvm.hotspot.debugger.dummy.DummyAddress(this, l);
  }

  public long getAddressValue(Address addr) {
    if (addr == null) return 0;
    return ((sun.jvm.hotspot.debugger.dummy.DummyAddress) addr).getValue();
  }
  ...
  String addressToString(sun.jvm.hotspot.debugger.dummy.DummyAddress addr) {
