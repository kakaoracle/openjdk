...
public class CompactibleFreeListSpace extends CompactibleSpace {
   ...
   public long used0() {
      ...
      for (Iterator itr = regions.iterator(); itr.hasNext();) {
         sun.jvm.hotspot.memory.MemRegion mr = (sun.jvm.hotspot.memory.MemRegion) itr.next();
   ...
   public long free() {
      ...
      // large block
      sun.jvm.hotspot.memory.AFLBinaryTreeDictionary aflbd = (sun.jvm.hotspot.memory.AFLBinaryTreeDictionary) VMObjectFactory.newObject(AFLBinaryTreeDictionary.class,
   ...
   public List/*<MemRegion>*/ getLiveRegions() {
      ...
      for (; cur.lessThan(limit);) {
         ...
         if (sun.jvm.hotspot.memory.FreeChunk.indicatesFreeChunk(cur)) {
            if (! cur.equals(regionStart)) {
               res.add(new MemRegion(regionStart, cur));
            }
            sun.jvm.hotspot.memory.FreeChunk fc = (sun.jvm.hotspot.memory.FreeChunk) VMObjectFactory.newObject(FreeChunk.class, cur);
