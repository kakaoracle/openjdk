...
public class PerfDataEntry extends VMObject {
    ...
    public int dataType() {
        ...
        return sun.jvm.hotspot.runtime.BasicType.charToType(ch);
    }
    ...
    public boolean booleanValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tBoolean, "not a boolean");
        }
    ...
    public char charValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tChar, "not a char");
        }
    ...
    public byte byteValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tByte, "not a byte");
        }
    ...
    public short shortValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tShort, "not a short");
        }
    ...
    public int intValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tInt, "not an int");
        }
    ...
    public long longValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tLong, "not a long");
        }
    ...
    public float floatValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tFloat, "not a float");
        }
    ...
    public double doubleValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tDouble, "not a double");
        }
    ...
    public boolean[] booleanArrayValue() {
        ...
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tBoolean, "not a boolean vector");
        }
    ...
    public char[] charArrayValue() {
        ...
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tChar, "not a char vector");
        }
    ...
    public byte[] byteArrayValue() {
        ...
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tByte, "not a byte vector");
        }
    ...
    public short[] shortArrayValue() {
        ...
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tShort, "not a short vector");
        }
    ...
    public int[] intArrayValue() {
        ...
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tInt, "not an int vector");
        }
        int[] res = new int[len];
        final int off = dataOffset();
    ...
    public long[] longArrayValue() {
        ...
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tLong, "not a long vector");
        }
    ...
    public float[] floatArrayValue() {
        ...
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tFloat, "not a float vector");
        }
    ...
    public double[] doubleArrayValue() {
        ...
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 &&
                        dataType() == sun.jvm.hotspot.runtime.BasicType.tDouble, "not a double vector");
        }
    ...
    public String valueAsString() {
        ...
        if (len == 0) { // scalar
            switch (dataType) {
            case sun.jvm.hotspot.runtime.BasicType.tBoolean:
                str = Boolean.toString(booleanValue());
                break;
            case sun.jvm.hotspot.runtime.BasicType.tChar:
                str = "'" + Character.toString(charValue()) + "'";
                break;
            case sun.jvm.hotspot.runtime.BasicType.tByte:
                str = Byte.toString(byteValue());
                break;
            case sun.jvm.hotspot.runtime.BasicType.tShort:
                str = Short.toString(shortValue());
                break;
            case sun.jvm.hotspot.runtime.BasicType.tInt:
                str = Integer.toString(intValue());
                break;
            case sun.jvm.hotspot.runtime.BasicType.tLong:
                str = Long.toString(longValue());
                break;
            case sun.jvm.hotspot.runtime.BasicType.tFloat:
                str = Float.toString(floatValue());
                break;
            case sun.jvm.hotspot.runtime.BasicType.tDouble:
