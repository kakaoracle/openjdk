...
public abstract class DebuggerBase implements Debugger {
  ...
  class Fetcher implements PageFetcher {
    public sun.jvm.hotspot.debugger.Page fetchPage(long pageBaseAddress, long numBytes) {
      ...
      sun.jvm.hotspot.debugger.ReadResult res = readBytesFromProcess(pageBaseAddress, numBytes);
      if (res.getData() == null) {
        return new sun.jvm.hotspot.debugger.Page(pageBaseAddress, numBytes);
      }
