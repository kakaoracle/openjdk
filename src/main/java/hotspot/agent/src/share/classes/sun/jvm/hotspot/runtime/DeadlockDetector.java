...
public class DeadlockDetector {
    ...
    public static void print(PrintStream tty, boolean concurrentLocks) {
        ...
        sun.jvm.hotspot.runtime.JavaThread currentThread = null, previousThread = null;
        sun.jvm.hotspot.runtime.ObjectMonitor waitingToLockMonitor = null;
        Oop waitingToLockBlocker = null;

        threads = sun.jvm.hotspot.runtime.VM.getVM().getThreads();
        heap = sun.jvm.hotspot.runtime.VM.getVM().getObjectHeap();
        createThreadTable();
        ...
        while (i.hasNext()) {
            ...
            thisDfn = globalDfn;
            sun.jvm.hotspot.runtime.JavaThread thread = (sun.jvm.hotspot.runtime.JavaThread)e.getKey();
            ...
            while (waitingToLockMonitor != null ||
                ...
                waitingToLockMonitor = (sun.jvm.hotspot.runtime.ObjectMonitor)currentThread.getCurrentPendingMonitor();
                if (concurrentLocks) {
    ...
    private static void createThreadTable() {
        ...
        for (sun.jvm.hotspot.runtime.JavaThread cur = threads.first(); cur != null; cur = cur.next()) {
            // initialize dfn for each thread to -1
            threadTable.put(cur, new Integer(-1));
        }
    }

    private static int dfn(sun.jvm.hotspot.runtime.JavaThread thread) {
    ...
    private static void printOneDeadlock(PrintStream tty, sun.jvm.hotspot.runtime.JavaThread thread,
