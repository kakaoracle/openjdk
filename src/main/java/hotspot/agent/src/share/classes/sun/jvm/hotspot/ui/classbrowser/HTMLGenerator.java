...
package hotspot.agent.src.share.classes.sun.jvm.hotspot.ui.classbrowser;
...
public class HTMLGenerator implements /* imports */ ClassConstants {
   ...
   protected String genHTMLForRawDisassembly(Address startPc,
                                             String prevPCs) {
      try {
   ...
   class HTMLDisassembler implements InstructionVisitor {
      ...
      public void printAddress(long address) {
         Address addr = longToAddress(address);
   ...
   protected String genHTMLForRawDisassembly(Address addr,
                                             int size,
                                             String prevPCs) {
      try {
         final Formatter buf = new Formatter(genHTML);
