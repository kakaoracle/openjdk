...
public class JSJavaHeap extends DefaultScriptObject {
    ...
    public void forEachObject(Object[] args) {
        ...
        Klass kls = null;
        sun.jvm.hotspot.utilities.soql.Callable func = null;
        switch (args.length) {
        case 3: {
            Object b = args[2];
        ...
        case 1: {
            Object f = args[0];
            if (f != null && f instanceof sun.jvm.hotspot.utilities.soql.Callable) {
                func = (sun.jvm.hotspot.utilities.soql.Callable) f;
            } else {
        ...
        final sun.jvm.hotspot.utilities.soql.Callable finalFunc = func;
    ...
    public void forEachClass(Object[] args) {
        ...
        case 1: {
            Object f = args[0];
            if (f instanceof sun.jvm.hotspot.utilities.soql.Callable) {
                func = (sun.jvm.hotspot.utilities.soql.Callable) f;
            } else {
                return;
            }
