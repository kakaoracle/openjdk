...
public class IntervalNode extends sun.jvm.hotspot.utilities.RBNode {
  ...
  public IntervalNode(sun.jvm.hotspot.utilities.Interval interval, Comparator endpointComparator, Object data) {
    super(data);
