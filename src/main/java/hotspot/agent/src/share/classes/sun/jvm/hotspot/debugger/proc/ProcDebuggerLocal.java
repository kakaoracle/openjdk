...
package hotspot.agent.src.share.classes.sun.jvm.hotspot.debugger.proc;
...
public class ProcDebuggerLocal extends DebuggerBase implements ProcDebugger {
    ...
    public Address parseAddress(String addressString) throws NumberFormatException {
        ...
        return new sun.jvm.hotspot.debugger.proc.ProcAddress(this, addr);
    }
    ...
    public CDebugger getCDebugger() throws DebuggerException {
        if (cdbg == null) {
            cdbg = new sun.jvm.hotspot.debugger.proc.ProcCDebugger(this);
        }
        return cdbg;
    }
    ...
    /** From the ProcDebugger interface */
    public sun.jvm.hotspot.debugger.proc.ProcAddress readAddress(long address)
    throws UnmappedAddressException, UnalignedAddressException {
        long value = readAddressValue(address);
        return (value == 0 ? null : new sun.jvm.hotspot.debugger.proc.ProcAddress(this, value));
    }

    public sun.jvm.hotspot.debugger.proc.ProcAddress readCompOopAddress(long address)
    throws UnmappedAddressException, UnalignedAddressException {
        long value = readCompOopAddressValue(address);
        return (value == 0 ? null : new sun.jvm.hotspot.debugger.proc.ProcAddress(this, value));
    }

    public sun.jvm.hotspot.debugger.proc.ProcAddress readCompKlassAddress(long address)
    throws UnmappedAddressException, UnalignedAddressException {
    ...
    /** From the ProcDebugger interface */
    public sun.jvm.hotspot.debugger.proc.ProcOopHandle readOopHandle(long address)
    throws UnmappedAddressException, UnalignedAddressException, NotInHeapException {
        long   value = readAddressValue(address);
        return (value == 0 ? null : new sun.jvm.hotspot.debugger.proc.ProcOopHandle(this, value));
    }
    ...
    public long getAddressValue(Address addr) {
        ...
        return ((sun.jvm.hotspot.debugger.proc.ProcAddress) addr).getValue();
    }

    /** From the ProcDebugger interface */
    public Address newAddress(long value) {
        if (value == 0) return null;
        return new sun.jvm.hotspot.debugger.proc.ProcAddress(this, value);
    }
    ...
    throws DebuggerException {
        ...
        sun.jvm.hotspot.debugger.proc.SharedObject dso = (sun.jvm.hotspot.debugger.proc.SharedObject) nameToDsoMap.get(objectName);
        // The DSO can be null because we use this to search through known
        // DSOs in HotSpotTypeDataBase (for example)
        if (dso != null) {
            sun.jvm.hotspot.debugger.proc.ProcAddress addr = (sun.jvm.hotspot.debugger.proc.ProcAddress) dso.lookupSymbol(symbolName);
            if (addr != null) {
    ...
    private sun.jvm.hotspot.debugger.proc.SharedObject findDSOByName(String fullPathName) {
        if (loadObjectCache == null)
            return null;
        for (Iterator iter = loadObjectCache.iterator(); iter.hasNext(); ) {
            sun.jvm.hotspot.debugger.proc.SharedObject dso = (sun.jvm.hotspot.debugger.proc.SharedObject) iter.next();
    ...
    private native sun.jvm.hotspot.debugger.proc.ProcCFrame fillCFrameList0(long[] regs) throws DebuggerException;

    // helper called by fillCFrameList0
    private sun.jvm.hotspot.debugger.proc.ProcCFrame createSenderFrame(sun.jvm.hotspot.debugger.proc.ProcCFrame f, long pc, long fp) {
        sun.jvm.hotspot.debugger.proc.ProcCFrame sender = new sun.jvm.hotspot.debugger.proc.ProcCFrame(this, newAddress(pc), newAddress(fp));
        if (f != null) {
            f.setSender(sender);
        }
        return sender;
    ...
    private LoadObject createLoadObject(String fileName, long textsize, long base) {
        ...
        sun.jvm.hotspot.debugger.proc.SharedObject res = findDSOByName(fileName);
        if (res != null) {
            ...
            // new shared object.
            res = new sun.jvm.hotspot.debugger.proc.SharedObject(this, fileName, f.length(), baseAddr);
        }
