...
package hotspot.agent.src.share.classes.sun.jvm.hotspot.debugger.bsd;
...
public class BsdDebuggerLocal extends DebuggerBase implements BsdDebugger {
    ...
    private LoadObject createLoadObject(String fileName, long textsize,
       ...
       return new sun.jvm.hotspot.debugger.bsd.SharedObject(this, fileName, f.length(), baseAddr);
    }
    ...
    public Address parseAddress(String addressString)
        ...
        return new sun.jvm.hotspot.debugger.bsd.BsdAddress(this, addr);
    }
    ...
    public synchronized Address lookup(String objectName, String symbol) {
        ...
        if (isCore) {
            ...
            return (addr == 0)? null : new sun.jvm.hotspot.debugger.bsd.BsdAddress(this, handleGCC32ABI(addr, symbol));
        } else {
            class LookupByNameTask implements WorkerThreadTask {
                ...
                public void doit(BsdDebuggerLocal debugger) {
                    ...
                    result = (addr == 0 ? null : new sun.jvm.hotspot.debugger.bsd.BsdAddress(debugger, handleGCC32ABI(addr, symbol)));
                }
            }
    ...
    public ThreadProxy getThreadForIdentifierAddress(Address threadIdAddr, Address uniqueThreadIdAddr) {
        return new sun.jvm.hotspot.debugger.bsd.BsdThread(this, threadIdAddr, uniqueThreadIdAddr);
    }
    ...
    public ThreadProxy getThreadForThreadId(long id) {
        return new sun.jvm.hotspot.debugger.bsd.BsdThread(this, id);
    }
    ...
    /** From the BsdDebugger interface */
    public sun.jvm.hotspot.debugger.bsd.BsdAddress readAddress(long address)
            throws UnmappedAddressException, UnalignedAddressException {
        long value = readAddressValue(address);
        return (value == 0 ? null : new sun.jvm.hotspot.debugger.bsd.BsdAddress(this, value));
    }
    public sun.jvm.hotspot.debugger.bsd.BsdAddress readCompOopAddress(long address)
            throws UnmappedAddressException, UnalignedAddressException {
        long value = readCompOopAddressValue(address);
        return (value == 0 ? null : new sun.jvm.hotspot.debugger.bsd.BsdAddress(this, value));
    }

    public sun.jvm.hotspot.debugger.bsd.BsdAddress readCompKlassAddress(long address)
            throws UnmappedAddressException, UnalignedAddressException {
    ...
    /** From the BsdDebugger interface */
    public sun.jvm.hotspot.debugger.bsd.BsdOopHandle readOopHandle(long address)
            throws UnmappedAddressException, UnalignedAddressException,
                NotInHeapException {
        long value = readAddressValue(address);
        return (value == 0 ? null : new sun.jvm.hotspot.debugger.bsd.BsdOopHandle(this, value));
    }
    public sun.jvm.hotspot.debugger.bsd.BsdOopHandle readCompOopHandle(long address)
            throws UnmappedAddressException, UnalignedAddressException,
                NotInHeapException {
        long value = readCompOopAddressValue(address);
        return (value == 0 ? null : new sun.jvm.hotspot.debugger.bsd.BsdOopHandle(this, value));
    ...
    public long getAddressValue(Address addr) {
      ...
      return ((sun.jvm.hotspot.debugger.bsd.BsdAddress) addr).getValue();
    }

    /** From the BsdDebugger interface */
    public Address newAddress(long value) {
      if (value == 0) return null;
      return new sun.jvm.hotspot.debugger.bsd.BsdAddress(this, value);
    }
    ...
    public CDebugger getCDebugger() {
      if (cdbg == null) {
         ...
         cdbg = new sun.jvm.hotspot.debugger.bsd.BsdCDebugger(this);
      }
      return cdbg;
    }
    ...
    public long[] getJavaThreadsInfo() {
        ...
        while (t != null) {
            ...
            sun.jvm.hotspot.debugger.bsd.BsdThread bsdt = (sun.jvm.hotspot.debugger.bsd.BsdThread)t.getThreadProxy();
