...
public class MultiBranchData extends sun.jvm.hotspot.oops.ArrayData {
  ...
  static int perCaseSize() {
    return (perCaseCellCount) * sun.jvm.hotspot.oops.MethodData.cellSize;
  }
  static int relativeCountOffset() {
    return (relativeCountOffSet) * sun.jvm.hotspot.oops.MethodData.cellSize;
  }
