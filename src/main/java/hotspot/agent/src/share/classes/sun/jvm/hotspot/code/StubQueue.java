...
public class StubQueue extends VMObject {
  ...
  public sun.jvm.hotspot.code.Stub getStubContaining(Address pc) {
    if (contains(pc)) {
      int i = 0;
      for (sun.jvm.hotspot.code.Stub s = getFirst(); s != null; s = getNext(s)) {
  ...
  public boolean stubContains(sun.jvm.hotspot.code.Stub s, Address pc) {
  ...
  public sun.jvm.hotspot.code.Stub getNext(sun.jvm.hotspot.code.Stub s) {
  ...
  public sun.jvm.hotspot.code.Stub getPrev(sun.jvm.hotspot.code.Stub s) {
    if (getIndexOf(s) == getQueueBegin()) {
       return null;
    }

    sun.jvm.hotspot.code.Stub temp = getFirst();
    sun.jvm.hotspot.code.Stub prev = null;
  ...
  private sun.jvm.hotspot.code.Stub getStubAt(long offset) {
    checkIndex(offset);
    return (sun.jvm.hotspot.code.Stub) VMObjectFactory.newObject(stubType, getStubBuffer().addOffsetTo(offset));
  }

  private long getIndexOf(sun.jvm.hotspot.code.Stub s) {
