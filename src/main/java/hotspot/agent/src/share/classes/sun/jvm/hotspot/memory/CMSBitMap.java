...
public class CMSBitMap extends VMObject {
  ...
  public sun.jvm.hotspot.memory.VirtualSpace virtualSpace() {
    return (sun.jvm.hotspot.memory.VirtualSpace) VMObjectFactory.newObject(sun.jvm.hotspot.memory.VirtualSpace.class, addr.addOffsetTo(virtualSpaceFieldOffset));
  }
