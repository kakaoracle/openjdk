...
public class StackValue {
  ...
  public StackValue() {
    type = sun.jvm.hotspot.runtime.BasicType.getTConflict();
  }

  public StackValue(OopHandle h, long scalar_replaced) {
    handleValue = h;
    type = sun.jvm.hotspot.runtime.BasicType.getTObject();
  ...
  public StackValue(long i) {
    integerValue = i;
    type = sun.jvm.hotspot.runtime.BasicType.getTInt();
  }
  ...
  public OopHandle getObject() {
    if (Assert.ASSERTS_ENABLED) {
      Assert.that(type == sun.jvm.hotspot.runtime.BasicType.getTObject(), "type check");
    }
    return handleValue;
  }
  ...
  public long getInteger() {
    if (Assert.ASSERTS_ENABLED) {
      Assert.that(type == sun.jvm.hotspot.runtime.BasicType.getTInt(), "type check");
    }
    return integerValue;
  }
  ...
  public boolean equals(Object arg) {
    ...
    if (type == sun.jvm.hotspot.runtime.BasicType.getTObject()) {
      return handleValue.equals(sv.handleValue);
    } else if (type == sun.jvm.hotspot.runtime.BasicType.getTInt()) {
  ...
  public void printOn(PrintStream tty) {
    if (type == sun.jvm.hotspot.runtime.BasicType.getTInt()) {
      tty.print(integerValue + " (long) " + (int) integerValue + " (int)");
    } else if (type == sun.jvm.hotspot.runtime.BasicType.getTObject()) {
