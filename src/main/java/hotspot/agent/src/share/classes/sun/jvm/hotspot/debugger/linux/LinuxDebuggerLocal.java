...
import sun.jvm.hotspot.debugger.linux.LinuxCDebugger;
import sun.jvm.hotspot.debugger.linux.LinuxDebugger;
import sun.jvm.hotspot.debugger.linux.LinuxOopHandle;
import sun.jvm.hotspot.debugger.linux.LinuxThread;
import sun.jvm.hotspot.debugger.linux.SharedObject;
...
public class LinuxDebuggerLocal extends DebuggerBase implements LinuxDebugger {
    ...
    private LoadObject createLoadObject(String fileName, long textsize,
       ...
       return new sun.jvm.hotspot.debugger.linux.SharedObject(this, fileName, f.length(), baseAddr);
    }
    ...
    public Address parseAddress(String addressString)
        ...
        return new sun.jvm.hotspot.debugger.linux.LinuxAddress(this, addr);
    }
    ...
    public synchronized Address lookup(String objectName, String symbol) {
        ...
        if (isCore) {
            ...
            return (addr == 0)? null : new sun.jvm.hotspot.debugger.linux.LinuxAddress(this, handleGCC32ABI(addr, symbol));
        } else {
            class LookupByNameTask implements WorkerThreadTask {
                ...
                public void doit(LinuxDebuggerLocal debugger) {
                    ...
                    result = (addr == 0 ? null : new sun.jvm.hotspot.debugger.linux.LinuxAddress(debugger, handleGCC32ABI(addr, symbol)));
                }
            }
    ...
    public ThreadProxy getThreadForIdentifierAddress(Address addr) {
        return new sun.jvm.hotspot.debugger.linux.LinuxThread(this, addr);
    }

    /** From the ThreadAccess interface via Debugger and JVMDebugger */
    public ThreadProxy getThreadForThreadId(long id) {
        return new sun.jvm.hotspot.debugger.linux.LinuxThread(this, id);
    }
    ...
    /** From the LinuxDebugger interface */
    public sun.jvm.hotspot.debugger.linux.LinuxAddress readAddress(long address)
            throws UnmappedAddressException, UnalignedAddressException {
        long value = readAddressValue(address);
        return (value == 0 ? null : new sun.jvm.hotspot.debugger.linux.LinuxAddress(this, value));
    }
    public sun.jvm.hotspot.debugger.linux.LinuxAddress readCompOopAddress(long address)
            throws UnmappedAddressException, UnalignedAddressException {
        long value = readCompOopAddressValue(address);
        return (value == 0 ? null : new sun.jvm.hotspot.debugger.linux.LinuxAddress(this, value));
    }

    public sun.jvm.hotspot.debugger.linux.LinuxAddress readCompKlassAddress(long address)
            throws UnmappedAddressException, UnalignedAddressException {
    ...
    /** From the LinuxDebugger interface */
    public sun.jvm.hotspot.debugger.linux.LinuxOopHandle readOopHandle(long address)
            throws UnmappedAddressException, UnalignedAddressException,
                NotInHeapException {
        long value = readAddressValue(address);
        return (value == 0 ? null : new sun.jvm.hotspot.debugger.linux.LinuxOopHandle(this, value));
    }
    public sun.jvm.hotspot.debugger.linux.LinuxOopHandle readCompOopHandle(long address)
            throws UnmappedAddressException, UnalignedAddressException,
                NotInHeapException {
        long value = readCompOopAddressValue(address);
    ...
    public long getAddressValue(Address addr) {
      ...
      return ((sun.jvm.hotspot.debugger.linux.LinuxAddress) addr).getValue();
    }
    ...
    public CDebugger getCDebugger() {
      if (cdbg == null) {
         ...
         cdbg = new sun.jvm.hotspot.debugger.linux.LinuxCDebugger(this);
      }
      return cdbg;
    }
