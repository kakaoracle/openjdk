...
public class WindbgDebuggerLocal extends DebuggerBase implements WindbgDebugger {
  ...
  public synchronized boolean detach() {
    ...
    if (nameToDllMap != null) {
      for (Iterator iter = nameToDllMap.values().iterator(); iter.hasNext(); ) {
        sun.jvm.hotspot.debugger.windbg.DLL dll = (sun.jvm.hotspot.debugger.windbg.DLL) iter.next();
        dll.close();
      }
      nameToDllMap = null;
      loadObjects = null;
  ...
  public CDebugger getCDebugger() throws DebuggerException {
    if (cdbg == null) {
      ...
      if (! getCPU().equals("ia64")) {
         cdbg = new sun.jvm.hotspot.debugger.windbg.WindbgCDebugger(this);
      }
    }
    return cdbg;
  }
  ...
  /** From the WindbgDebugger interface */
  public sun.jvm.hotspot.debugger.windbg.WindbgAddress readAddress(long address)
    throws UnmappedAddressException, UnalignedAddressException {
    return (sun.jvm.hotspot.debugger.windbg.WindbgAddress) newAddress(readAddressValue(address));
  }

  public sun.jvm.hotspot.debugger.windbg.WindbgAddress readCompOopAddress(long address)
    throws UnmappedAddressException, UnalignedAddressException {
    return (sun.jvm.hotspot.debugger.windbg.WindbgAddress) newAddress(readCompOopAddressValue(address));
  }

  public sun.jvm.hotspot.debugger.windbg.WindbgAddress readCompKlassAddress(long address)
    throws UnmappedAddressException, UnalignedAddressException {
    return (sun.jvm.hotspot.debugger.windbg.WindbgAddress) newAddress(readCompKlassAddressValue(address));
  }

  /** From the WindbgDebugger interface */
  public sun.jvm.hotspot.debugger.windbg.WindbgOopHandle readOopHandle(long address)
    throws UnmappedAddressException, UnalignedAddressException, NotInHeapException {
    long value = readAddressValue(address);
    return (value == 0 ? null : new sun.jvm.hotspot.debugger.windbg.WindbgOopHandle(this, value));
  }
  public sun.jvm.hotspot.debugger.windbg.WindbgOopHandle readCompOopHandle(long address)
    throws UnmappedAddressException, UnalignedAddressException, NotInHeapException {
  ...
  private synchronized void addLoadObject(String file, long size, long base) {
    ...
    if (path != null) {
       sun.jvm.hotspot.debugger.windbg.DLL dll = null;
       if (useNativeLookup) {
          dll = new sun.jvm.hotspot.debugger.windbg.DLL(this, path, size,newAddress(base)) {
  ...
  public long getAddressValue(Address addr) {
    ...
    return ((sun.jvm.hotspot.debugger.windbg.WindbgAddress) addr).getValue();
  }

  /** From the WindbgDebugger interface */
  public Address newAddress(long value) {
    if (value == 0) return null;
    return new sun.jvm.hotspot.debugger.windbg.WindbgAddress(this, value);
  }
  ...
  synchronized long lookupByName(String objectName, String symbol) {
    ...
    sun.jvm.hotspot.debugger.windbg.DLL dll = (sun.jvm.hotspot.debugger.windbg.DLL) nameToDllMap.get(objectName);
    // The DLL can be null because we use this to search through known
    // DLLs in HotSpotTypeDataBase (for example)
    if (dll != null) {
      sun.jvm.hotspot.debugger.windbg.WindbgAddress addr = (sun.jvm.hotspot.debugger.windbg.WindbgAddress) dll.lookupSymbol(symbol);
      if (addr != null) {
  ...
  private sun.jvm.hotspot.debugger.windbg.DLL findDLLByName(String fullPathName) {
    for (Iterator iter = loadObjects.iterator(); iter.hasNext(); ) {
      sun.jvm.hotspot.debugger.windbg.DLL dll = (DLL) iter.next();
