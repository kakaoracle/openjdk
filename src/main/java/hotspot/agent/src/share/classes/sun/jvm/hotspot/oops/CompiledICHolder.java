...
public class CompiledICHolder extends VMObject {
  ...
  private static synchronized void initialize(TypeDataBase db) throws WrongTypeException {
    ...
    holderMethod = new sun.jvm.hotspot.oops.MetadataField(type.getAddressField("_holder_method"), 0);
    holderKlass  = new sun.jvm.hotspot.oops.MetadataField(type.getAddressField("_holder_klass"), 0);
  ...
  public sun.jvm.hotspot.oops.Method getHolderMethod() { return (Method) holderMethod.getValue(this); }
  public sun.jvm.hotspot.oops.Klass getHolderKlass()  { return (Klass)  holderKlass.getValue(this); }
