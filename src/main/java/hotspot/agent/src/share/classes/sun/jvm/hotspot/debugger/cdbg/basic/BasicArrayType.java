...
public class BasicArrayType extends sun.jvm.hotspot.debugger.cdbg.basic.BasicType implements ArrayType {
  ...
  Type resolveTypes(BasicCDebugInfoDataBase db, ResolveListener listener) {
    ...
    // ourselves (see below)
    if (!((sun.jvm.hotspot.debugger.cdbg.basic.BasicType) elementType).isLazy()) {
