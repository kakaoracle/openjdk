...
public class BytecodeLoad extends BytecodeLoadStore {
  ...
  public boolean isValid() {
    int jcode = javaCode();
    switch (jcode) {
       case sun.jvm.hotspot.interpreter.Bytecodes._iload:
       case sun.jvm.hotspot.interpreter.Bytecodes._lload:
       case sun.jvm.hotspot.interpreter.Bytecodes._fload:
       case sun.jvm.hotspot.interpreter.Bytecodes._dload:
