...
package hotspot.agent.src.share.classes.sun.jvm.hotspot.debugger.proc.sparc;
...
public class ProcSPARCThreadFactory implements ProcThreadFactory {
  ...
  public ThreadProxy createThreadWrapper(Address threadIdentifierAddr) {
    return new sun.jvm.hotspot.debugger.proc.sparc.ProcSPARCThread(debugger, threadIdentifierAddr);
  }
