...
public class BytecodeInvoke extends BytecodeWithCPIndex {
  ...
  // Testers
  public boolean isInvokeinterface() { return adjustedInvokeCode() == sun.jvm.hotspot.interpreter.Bytecodes._invokeinterface; }
  public boolean isInvokevirtual()   { return adjustedInvokeCode() == sun.jvm.hotspot.interpreter.Bytecodes._invokevirtual;   }
  public boolean isInvokestatic()    { return adjustedInvokeCode() == sun.jvm.hotspot.interpreter.Bytecodes._invokestatic;    }
  public boolean isInvokespecial()   { return adjustedInvokeCode() == sun.jvm.hotspot.interpreter.Bytecodes._invokespecial;   }
