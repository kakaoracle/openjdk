...
public class InstanceMirrorKlass extends sun.jvm.hotspot.oops.InstanceKlass {
  static {
  ...
  public long getObjectSize(sun.jvm.hotspot.oops.Oop o) {
    return sun.jvm.hotspot.oops.java_lang_Class.getOopSize(o) * VM.getVM().getAddressSize();
  }
  ...
  public void iterateNonStaticFields(OopVisitor visitor, Oop obj) {
    ...
    if (klass instanceof sun.jvm.hotspot.oops.InstanceKlass) {
