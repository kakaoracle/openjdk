...
public class ConstantPoolCacheEntry {
  ...
  static sun.jvm.hotspot.oops.NamedFieldIdentifier f1FieldName = new sun.jvm.hotspot.oops.NamedFieldIdentifier("_f1");
  static sun.jvm.hotspot.oops.NamedFieldIdentifier f2FieldName = new sun.jvm.hotspot.oops.NamedFieldIdentifier("_f2");
  static sun.jvm.hotspot.oops.NamedFieldIdentifier flagsFieldName = new NamedFieldIdentifier("_flags");

  public void iterateFields(MetadataVisitor visitor) {
    visitor.doOop(new OopField(f1FieldName, f1.getOffset() + offset, true), true);
    visitor.doInt(new sun.jvm.hotspot.oops.IntField(f2FieldName, f2.getOffset() + offset, true), true);
