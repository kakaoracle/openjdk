...
public class SOQLEngine extends JSJavaScriptEngine {
   ...
   */
   public synchronized void executeQuery(String query, ObjectVisitor visitor)
      ...
      executeQuery(new sun.jvm.hotspot.utilities.soql.SOQLQuery(selectExpr, isInstanceOf, className, identifier, whereExpr), visitor);
   }

   private void executeQuery(sun.jvm.hotspot.utilities.soql.SOQLQuery q, ObjectVisitor visitor) throws SOQLException {
