...
public class ObjectReader {
   ...
   private void setHashtableEntry(java.util.Hashtable p, Oop oop) {
      ...
      if (DEBUG) {
         if (sun.jvm.hotspot.utilities.Assert.ASSERTS_ENABLED) {
            sun.jvm.hotspot.utilities.Assert.that(ik.getName().equals(javaUtilHashtableEntry()), "Not a Hashtable$Entry?");
   ...
   protected Object getHashtable(Instance oop, boolean isProperties) {
      ...
      java.util.Hashtable table = (isProperties) ? new Properties()
   ...
   public Object readMethodOrConstructor(Method m)
   ...
   public java.lang.reflect.Method readMethod(Method m)
            throws NoSuchMethodException, ClassNotFoundException {
   ...
   public java.lang.reflect.Constructor readConstructor(Method m)
            throws NoSuchMethodException, ClassNotFoundException {
   ...
   public java.lang.reflect.Field readField(Field f)
