...
public class MetadataTreeNodeAdapter extends sun.jvm.hotspot.ui.tree.FieldTreeNodeAdapter {
  ...
  class Fetcher extends DefaultMetadataVisitor {
    ...
    public void doByte(ByteField field, boolean isVMField) {
      if (curField == index) {
        child = new sun.jvm.hotspot.ui.tree.LongTreeNodeAdapter(field.getValue(getObj()) & 0xFF, field.getID(), getTreeTableMode());
      }
      ++curField;
    }
    ...
    public void doShort(ShortField field, boolean isVMField) {
      if (curField == index) {
        child = new sun.jvm.hotspot.ui.tree.LongTreeNodeAdapter(field.getValue(getObj()) & 0xFFFF, field.getID(), getTreeTableMode());
      }
      ++curField;
    }
    ...
    public void doInt(IntField field, boolean isVMField) {
      if (curField == index) {
        child = new sun.jvm.hotspot.ui.tree.LongTreeNodeAdapter(field.getValue(getObj()) & 0xFFFFFFFF, field.getID(), getTreeTableMode());
      }
      ++curField;
    }
    ...
    public void doLong(LongField field, boolean isVMField) {
      if (curField == index) {
        child = new sun.jvm.hotspot.ui.tree.LongTreeNodeAdapter(field.getValue(getObj()), field.getID(), getTreeTableMode());
      }
      ++curField;
    }
