...
public abstract class SignatureIterator {
  ...
  protected int parseType() {
    ...
    case 'B': doByte  (); _index++; return sun.jvm.hotspot.runtime.BasicTypeSize.getTByteSize();
    case 'C': doChar  (); _index++; return sun.jvm.hotspot.runtime.BasicTypeSize.getTCharSize();
    case 'D': doDouble(); _index++; return sun.jvm.hotspot.runtime.BasicTypeSize.getTDoubleSize();
    case 'F': doFloat (); _index++; return sun.jvm.hotspot.runtime.BasicTypeSize.getTFloatSize();
    case 'I': doInt   (); _index++; return sun.jvm.hotspot.runtime.BasicTypeSize.getTIntSize();
    case 'J': doLong  (); _index++; return sun.jvm.hotspot.runtime.BasicTypeSize.getTLongSize();
    case 'S': doShort (); _index++; return sun.jvm.hotspot.runtime.BasicTypeSize.getTShortSize();
    case 'Z': doBool  (); _index++; return sun.jvm.hotspot.runtime.BasicTypeSize.getTBooleanSize();
    case 'V':
      {
        if (!isReturnType()) {
        ...
        doVoid(); _index++;
        return sun.jvm.hotspot.runtime.BasicTypeSize.getTVoidSize();
      }
    case 'L':
      {
        int begin = ++_index;
        ...
        return sun.jvm.hotspot.runtime.BasicTypeSize.getTObjectSize();
      }
    case '[':
      {
        int begin = ++_index;
