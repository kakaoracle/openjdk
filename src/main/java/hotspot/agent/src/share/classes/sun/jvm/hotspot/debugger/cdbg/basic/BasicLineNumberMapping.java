...
public class BasicLineNumberMapping {
  ...
  public void addLineNumberInfo(sun.jvm.hotspot.debugger.cdbg.basic.BasicLineNumberInfo info) {
    if (infoList == null) {
  ...
  public void sort() {
    ...
    Collections.sort(infoList, new Comparator() {
        public int compare(Object o1, Object o2) {
          sun.jvm.hotspot.debugger.cdbg.basic.BasicLineNumberInfo l1 = (sun.jvm.hotspot.debugger.cdbg.basic.BasicLineNumberInfo) o1;
          sun.jvm.hotspot.debugger.cdbg.basic.BasicLineNumberInfo l2 = (sun.jvm.hotspot.debugger.cdbg.basic.BasicLineNumberInfo) o2;
  ...
  public void recomputeEndPCs() {
    ...
    for (int i = 0; i < infoList.size() - 1; i++) {
      sun.jvm.hotspot.debugger.cdbg.basic.BasicLineNumberInfo i1 = get(i);
      sun.jvm.hotspot.debugger.cdbg.basic.BasicLineNumberInfo i2 = get(i + 1);
      i1.setEndPC(i2.getStartPC());
    }
  }

  public sun.jvm.hotspot.debugger.cdbg.basic.BasicLineNumberInfo lineNumberForPC(Address pc) throws DebuggerException {
  ...
  private sun.jvm.hotspot.debugger.cdbg.basic.BasicLineNumberInfo get(int i) {
    return (sun.jvm.hotspot.debugger.cdbg.basic.BasicLineNumberInfo) infoList.get(i);
  }

  private sun.jvm.hotspot.debugger.cdbg.basic.BasicLineNumberInfo searchLineNumbers(Address addr, int lowIdx, int highIdx) {
    ...
    sun.jvm.hotspot.debugger.cdbg.basic.BasicLineNumberInfo info = get(midIdx);
