...
public class ObjArrayKlass extends ArrayKlass {
  ...
  private static synchronized void initialize(TypeDataBase db) throws WrongTypeException {
    ...
    elementKlass = new sun.jvm.hotspot.oops.MetadataField(type.getAddressField("_element_klass"), 0);
    bottomKlass  = new sun.jvm.hotspot.oops.MetadataField(type.getAddressField("_bottom_klass"), 0);
  }
  ...
  public sun.jvm.hotspot.oops.Klass getElementKlass() { return (sun.jvm.hotspot.oops.Klass) elementKlass.getValue(this); }
  public sun.jvm.hotspot.oops.Klass getBottomKlass()  { return (sun.jvm.hotspot.oops.Klass) bottomKlass.getValue(this); }
