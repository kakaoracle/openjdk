...
public class ObjectHeap {
  ...
  public boolean equal(sun.jvm.hotspot.oops.Oop o1, sun.jvm.hotspot.oops.Oop o2) {
  ...
  /** Takes a BasicType and returns the corresponding primitive array
      klass */
  public sun.jvm.hotspot.oops.Klass typeArrayKlassObj(int t) {
  ...
  public static interface ObjectFilter {
    public boolean canInclude(sun.jvm.hotspot.oops.Oop obj);
  }
  ...
  public void iterateObjectsOfKlass(HeapVisitor visitor, final sun.jvm.hotspot.oops.Klass k, boolean includeSubtypes) {
    if (includeSubtypes) {
      if (k.isFinal()) {
  ...
  public void iterateObjectsOfKlass(HeapVisitor visitor, final sun.jvm.hotspot.oops.Klass k) {
  ...
  public boolean isValidMethod(Address handle) {
    try {
      sun.jvm.hotspot.oops.Method m = (Method) Metadata.instantiateWrapperFor(handle);
      return true;
    } catch (Exception e) {
      return false;
  }
  ...
  public sun.jvm.hotspot.oops.Oop newOop(OopHandle handle) {
    ...
    sun.jvm.hotspot.oops.Klass klass = sun.jvm.hotspot.oops.Oop.getKlassForOopHandle(handle);
    if (klass != null) {
  ...
  private void iterateExact(HeapVisitor visitor, final sun.jvm.hotspot.oops.Klass k) {
    iterateLiveRegions(collectLiveRegions(), visitor, new ObjectFilter() {
          public boolean canInclude(sun.jvm.hotspot.oops.Oop obj) {
            sun.jvm.hotspot.oops.Klass tk = obj.getKlass();
  ...
  private void iterateSubtypes(HeapVisitor visitor, final sun.jvm.hotspot.oops.Klass k) {
    iterateLiveRegions(collectLiveRegions(), visitor, new ObjectFilter() {
          public boolean canInclude(sun.jvm.hotspot.oops.Oop obj) {
