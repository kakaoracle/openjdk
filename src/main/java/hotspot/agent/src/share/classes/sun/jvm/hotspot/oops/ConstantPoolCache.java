...
public class ConstantPoolCache extends Metadata {
  ...
  private static synchronized void initialize(TypeDataBase db) throws WrongTypeException {
    ...
    constants      = new sun.jvm.hotspot.oops.MetadataField(type.getAddressField("_constant_pool"), 0);
  ...
  public sun.jvm.hotspot.oops.ConstantPool getConstants() { return (ConstantPool) constants.getValue(this); }
