...
public abstract class Generation extends VMObject {
  ...
  public sun.jvm.hotspot.memory.MemRegion reserved() {
    return new sun.jvm.hotspot.memory.MemRegion(addr.addOffsetTo(reservedFieldOffset));
  }
  ...
  protected sun.jvm.hotspot.memory.VirtualSpace virtualSpace() {
    return (sun.jvm.hotspot.memory.VirtualSpace) VMObjectFactory.newObject(VirtualSpace.class, addr.addOffsetTo(virtualSpaceFieldOffset));
  }
