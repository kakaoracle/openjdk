...
public class TestDebugInfo implements DebugVC50SubsectionTypes, DebugVC50SymbolTypes, DebugVC50TypeLeafIndices {
  public static void main(String[] args) {
    ...
    try {
      sun.jvm.hotspot.debugger.win32.coff.COFFFile file = COFFFileParser.getParser().parse(args[0]);
      if (file.isImage()) {
      ...
      sun.jvm.hotspot.debugger.win32.coff.DebugVC50 vc50 = getDebugVC50(file);
      if (vc50 == null) {
