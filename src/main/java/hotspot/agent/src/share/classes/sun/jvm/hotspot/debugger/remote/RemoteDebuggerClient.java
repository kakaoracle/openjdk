...
public class RemoteDebuggerClient extends DebuggerBase implements JVMDebugger {
  ...
  public Address parseAddress(String addressString) throws NumberFormatException {
    ...
    return new sun.jvm.hotspot.debugger.remote.RemoteAddress(this, addr);
  }
  ...
  public OopHandle lookupOop(String objectName, String symbol) {
    try {
      ...
      return new sun.jvm.hotspot.debugger.remote.RemoteOopHandle(this, addr);
    }
    catch (RemoteException e) {
      throw new DebuggerException(e);
    }
  ...
  public long getAddressValue(Address addr) throws DebuggerException {
    ...
    return ((sun.jvm.hotspot.debugger.remote.RemoteAddress) addr).getValue();
  }

  public Address newAddress(long value) {
    if (value == 0) return null;
    return new sun.jvm.hotspot.debugger.remote.RemoteAddress(this, value);
  }

  sun.jvm.hotspot.debugger.remote.RemoteAddress readAddress(long address)
    throws UnmappedAddressException, UnalignedAddressException {
    long value = readAddressValue(address);
    return (value == 0 ? null : new sun.jvm.hotspot.debugger.remote.RemoteAddress(this, value));
  }

  sun.jvm.hotspot.debugger.remote.RemoteAddress readCompOopAddress(long address)
    throws UnmappedAddressException, UnalignedAddressException {
    long value = readCompOopAddressValue(address);
    return (value == 0 ? null : new sun.jvm.hotspot.debugger.remote.RemoteAddress(this, value));
  }

  sun.jvm.hotspot.debugger.remote.RemoteAddress readCompKlassAddress(long address)
    throws UnmappedAddressException, UnalignedAddressException {
    long value = readCompKlassAddressValue(address);
    return (value == 0 ? null : new sun.jvm.hotspot.debugger.remote.RemoteAddress(this, value));
  }

  sun.jvm.hotspot.debugger.remote.RemoteOopHandle readOopHandle(long address)
    throws UnmappedAddressException, UnalignedAddressException, NotInHeapException {
    long value = readAddressValue(address);
    return (value == 0 ? null : new sun.jvm.hotspot.debugger.remote.RemoteOopHandle(this, value));
  }

  sun.jvm.hotspot.debugger.remote.RemoteOopHandle readCompOopHandle(long address)
    throws UnmappedAddressException, UnalignedAddressException, NotInHeapException {
    long value = readCompOopAddressValue(address);
    return (value == 0 ? null : new sun.jvm.hotspot.debugger.remote.RemoteOopHandle(this, value));
  }
