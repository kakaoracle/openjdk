...
public class GenerateOopMap {
  ...
  static sun.jvm.hotspot.oops.CellTypeState[] epsilonCTS = { sun.jvm.hotspot.oops.CellTypeState.bottom };
  static sun.jvm.hotspot.oops.CellTypeState refCTS     = sun.jvm.hotspot.oops.CellTypeState.ref;
  static sun.jvm.hotspot.oops.CellTypeState valCTS     = sun.jvm.hotspot.oops.CellTypeState.value;
  static sun.jvm.hotspot.oops.CellTypeState[]    vCTS    = { sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.bottom };
  static sun.jvm.hotspot.oops.CellTypeState[]    rCTS    = { sun.jvm.hotspot.oops.CellTypeState.ref,   sun.jvm.hotspot.oops.CellTypeState.bottom };
  static sun.jvm.hotspot.oops.CellTypeState[]   rrCTS    = { sun.jvm.hotspot.oops.CellTypeState.ref,   sun.jvm.hotspot.oops.CellTypeState.ref,   sun.jvm.hotspot.oops.CellTypeState.bottom };
  static sun.jvm.hotspot.oops.CellTypeState[]   vrCTS    = { sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.ref,   sun.jvm.hotspot.oops.CellTypeState.bottom };
  static sun.jvm.hotspot.oops.CellTypeState[]   vvCTS    = { sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.bottom };
  static sun.jvm.hotspot.oops.CellTypeState[]  rvrCTS    = { sun.jvm.hotspot.oops.CellTypeState.ref,   sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.ref,   sun.jvm.hotspot.oops.CellTypeState.bottom };
  static sun.jvm.hotspot.oops.CellTypeState[]  vvrCTS    = { sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.ref,   sun.jvm.hotspot.oops.CellTypeState.bottom };
  static sun.jvm.hotspot.oops.CellTypeState[]  vvvCTS    = { sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.bottom };
  static sun.jvm.hotspot.oops.CellTypeState[] vvvrCTS    = { sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.ref,   sun.jvm.hotspot.oops.CellTypeState.bottom };
  static sun.jvm.hotspot.oops.CellTypeState[] vvvvCTS    = { sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.value, sun.jvm.hotspot.oops.CellTypeState.bottom };
  ...
  static class ComputeCallStack extends SignatureIterator {
    ...
    void set(sun.jvm.hotspot.oops.CellTypeState state)         { _effect.get(_idx++).set(state); }
    int  length()                         { return _idx; };

    public void doBool  ()              { set(sun.jvm.hotspot.oops.CellTypeState.value); }
    public void doChar  ()              { set(sun.jvm.hotspot.oops.CellTypeState.value); }
    public void doFloat ()              { set(sun.jvm.hotspot.oops.CellTypeState.value); }
    public void doByte  ()              { set(sun.jvm.hotspot.oops.CellTypeState.value); }
    public void doShort ()              { set(sun.jvm.hotspot.oops.CellTypeState.value); }
    public void doInt   ()              { set(sun.jvm.hotspot.oops.CellTypeState.value); }
    public void doVoid  ()              { set(sun.jvm.hotspot.oops.CellTypeState.bottom);}
    public void doObject(int begin, int end) { set(sun.jvm.hotspot.oops.CellTypeState.ref); }
    public void doArray (int begin, int end) { set(sun.jvm.hotspot.oops.CellTypeState.ref); }

    public void doDouble()              { set(sun.jvm.hotspot.oops.CellTypeState.value);
                                          set(sun.jvm.hotspot.oops.CellTypeState.value); }
    public void doLong  ()              { set(sun.jvm.hotspot.oops.CellTypeState.value);
                                          set(sun.jvm.hotspot.oops.CellTypeState.value); }

    ComputeCallStack(sun.jvm.hotspot.oops.Symbol signature) {
      super(signature);
    }
    ...
    int computeForParameters(boolean is_static, CellTypeStateList effect) {
      ...
      if (!is_static) {
        effect.get(_idx++).set(sun.jvm.hotspot.oops.CellTypeState.ref);
      }
    ...
    int computeForReturntype(CellTypeStateList effect) {
      ...
      _effect = effect;
      iterateReturntype();
      set(sun.jvm.hotspot.oops.CellTypeState.bottom);  // Always terminate with a bottom state, so ppush works
  ...
  static class ComputeEntryStack extends SignatureIterator {
    ...
    public void doInt   ()              { set(sun.jvm.hotspot.oops.CellTypeState.value); }
    public void doVoid  ()              { set(sun.jvm.hotspot.oops.CellTypeState.bottom);}
    public void doObject(int begin, int end) { set(sun.jvm.hotspot.oops.CellTypeState.makeSlotRef(_idx)); }
    public void doArray (int begin, int end) { set(sun.jvm.hotspot.oops.CellTypeState.makeSlotRef(_idx)); }
    ...
    ComputeEntryStack(sun.jvm.hotspot.oops.Symbol signature) {
      super(signature);
    }
    ...
    int computeForParameters(boolean is_static, CellTypeStateList effect) {
      ...
      if (!is_static) {
        effect.get(_idx++).set(sun.jvm.hotspot.oops.CellTypeState.makeSlotRef(0));
      }
  ...
  static class RetTable {
    ...
    RetTable() {}
    void computeRetTable(sun.jvm.hotspot.oops.Method method) {
  ...
  // Main variables
  sun.jvm.hotspot.oops.Method _method;         // The method we are examining
  ...
  void            makeContextUninitialized () {
    ...
    for (int i = 0; i < _max_locals; i++)
      vs.get(i).set(sun.jvm.hotspot.oops.CellTypeState.uninit);

    _stack_top = 0;
    _monitor_top = 0;
  }

  int             methodsigToEffect          (sun.jvm.hotspot.oops.Symbol signature, boolean isStatic, CellTypeStateList effect) {
  ...
  boolean         mergeStateVectors          (CellTypeStateList cts, CellTypeStateList bbts) {
    ...
    for (i = len - 1; i >= 0; i--) {
      sun.jvm.hotspot.oops.CellTypeState v = cts.get(i).merge(bbts.get(i), i);
  ...
  void            copyState                  (CellTypeStateList dst, CellTypeStateList src) {
    ...
    for (int i = 0; i < len; i++) {
      if (src.get(i).isNonlockReference()) {
        dst.get(i).set(sun.jvm.hotspot.oops.CellTypeState.makeSlotRef(i));
      } else {
  ...
  void            setVar                     (int localNo, sun.jvm.hotspot.oops.CellTypeState cts) {
    if (Assert.ASSERTS_ENABLED) {
  ...
  sun.jvm.hotspot.oops.CellTypeState getVar                     (int localNo) {
    if (Assert.ASSERTS_ENABLED) {
  ...
  void            push                       (sun.jvm.hotspot.oops.CellTypeState cts) {
  ...
  sun.jvm.hotspot.oops.CellTypeState monitorPop                 () {
    ...
    if (_monitor_top == 0) {
      ...
      return sun.jvm.hotspot.oops.CellTypeState.ref; // just to keep the analysis going.
    }
    return  monitors().get(--_monitor_top).copy();
  }

  void            monitorPush                (sun.jvm.hotspot.oops.CellTypeState cts) {
    if (Assert.ASSERTS_ENABLED) {
  ...
  void            replaceAllCTSMatches       (sun.jvm.hotspot.oops.CellTypeState match,
  ...
  void  interp1                             (BytecodeStream itr) {
    ...
    case Bytecodes._new:               ppush1(sun.jvm.hotspot.oops.CellTypeState.makeLineRef(itr.bci()));
      break;
    ...
    if (_has_exceptions) {
      ...
      for(int i = 0; i< exct.length; i++) {
        ...
        if (start_pc <= bci && bci < end_pc) {
          ...
          sun.jvm.hotspot.oops.CellTypeState cOpStck_0 = cOpStck.get(0).copy();
          ...
          cOpStck.get(0).set(sun.jvm.hotspot.oops.CellTypeState.makeSlotRef(_max_locals));
          _stack_top = 1;
  ...
  void  checkType                           (sun.jvm.hotspot.oops.CellTypeState expected, sun.jvm.hotspot.oops.CellTypeState actual) {
  ...
  void  ppstore                             (sun.jvm.hotspot.oops.CellTypeState[] in, int loc_no) {
    for (int i = 0; i < in.length && !in[i].equal(sun.jvm.hotspot.oops.CellTypeState.bottom); i++) {
      sun.jvm.hotspot.oops.CellTypeState expected = in[i];
      sun.jvm.hotspot.oops.CellTypeState actual   = pop();
  ...
  void  ppload                              (sun.jvm.hotspot.oops.CellTypeState[] out, int loc_no) {
    for (int i = 0; i < out.length && !out[i].equal(sun.jvm.hotspot.oops.CellTypeState.bottom); i++) {
      sun.jvm.hotspot.oops.CellTypeState out1 = out[i];
      sun.jvm.hotspot.oops.CellTypeState vcts = getVar(loc_no);
      if (Assert.ASSERTS_ENABLED) {
  ...
  void  ppush1                              (sun.jvm.hotspot.oops.CellTypeState in) {
    if (Assert.ASSERTS_ENABLED) {
  ...
  void  ppush                               (sun.jvm.hotspot.oops.CellTypeState[] in) {
    for (int i = 0; i < in.length && !in[i].equal(sun.jvm.hotspot.oops.CellTypeState.bottom); i++) {
      ppush1(in[i]);
    }
  }
  ...
  void  ppush                               (CellTypeStateList in) {
    for (int i = 0; i < in.size() && !in.get(i).equal(sun.jvm.hotspot.oops.CellTypeState.bottom); i++) {
      ppush1(in.get(i));
    }
  }

  void  ppop1                               (sun.jvm.hotspot.oops.CellTypeState out) {
    sun.jvm.hotspot.oops.CellTypeState actual = pop();
    if (DEBUG) {
  ...
  void  ppop                                (sun.jvm.hotspot.oops.CellTypeState[] out) {
    for (int i = 0; i < out.length && !out[i].equal(sun.jvm.hotspot.oops.CellTypeState.bottom); i++) {
      ppop1(out[i]);
    }
  }
  ...
  void  pp                                  (sun.jvm.hotspot.oops.CellTypeState[] in, sun.jvm.hotspot.oops.CellTypeState[] out) {
    ppop(in);
    ppush(out);
  }

  void  ppNewRef                            (sun.jvm.hotspot.oops.CellTypeState[] in, int bci) {
    ppop(in);
    ppush1(sun.jvm.hotspot.oops.CellTypeState.makeLineRef(bci));
  }

  void  ppdupswap                           (int poplen, String out) {
    sun.jvm.hotspot.oops.CellTypeState[] actual = new sun.jvm.hotspot.oops.CellTypeState[5];
  ...
  void  doLdc                               (int bci) {
    ...
    sun.jvm.hotspot.oops.ConstantPool cp  = method().getConstants();
    BasicType     bt = ldc.resultType();
    sun.jvm.hotspot.oops.CellTypeState cts = (bt == BasicType.T_OBJECT) ? sun.jvm.hotspot.oops.CellTypeState.makeLineRef(bci) : valCTS;
    ppush1(cts);
  }

  void  doAstore                            (int idx) {
    sun.jvm.hotspot.oops.CellTypeState r_or_p = pop();
  ...
  void  doJsr                               (int targBCI) {
    push(sun.jvm.hotspot.oops.CellTypeState.makeAddr(targBCI));
  }
  ...
  void  doField                             (boolean is_get, boolean is_static, int idx, int bci) {
    ...
    sun.jvm.hotspot.oops.Symbol signature       = cp.getSymbolAt(signatureIdx);
    ...
    sun.jvm.hotspot.oops.CellTypeState[] temp = new sun.jvm.hotspot.oops.CellTypeState[4];
    sun.jvm.hotspot.oops.CellTypeState[] eff  = sigcharToEffect(sigch, bci, temp);

    sun.jvm.hotspot.oops.CellTypeState[] in = new sun.jvm.hotspot.oops.CellTypeState[4];
    ...
    if (!is_static) in[i++] = sun.jvm.hotspot.oops.CellTypeState.ref;
    in[i] = sun.jvm.hotspot.oops.CellTypeState.bottom;
    if (Assert.ASSERTS_ENABLED) {
  ...
  void  doMethod                            (boolean is_static, boolean is_interface, int idx, int bci) {
    ...
    // Temporary hack.
    if (out.get(0).equal(sun.jvm.hotspot.oops.CellTypeState.ref) && out.get(1).equal(sun.jvm.hotspot.oops.CellTypeState.bottom)) {
      out.get(0).set(sun.jvm.hotspot.oops.CellTypeState.makeLineRef(bci));
    }
  ...
  void  doMonitorenter                      (int bci) {
    ...
    sun.jvm.hotspot.oops.CellTypeState lock = sun.jvm.hotspot.oops.CellTypeState.makeLockRef(bci);
  ...
  void  doMonitorexit                       (int bci) {
    ...
    checkType(refCTS, actual);
    sun.jvm.hotspot.oops.CellTypeState expected = monitorPop();
    if (!actual.isLockReference() || !expected.equal(actual)) {
      ...
      replaceAllCTSMatches(actual, sun.jvm.hotspot.oops.CellTypeState.makeLineRef(bci));
    }
  ...
  sun.jvm.hotspot.oops.CellTypeState[] sigcharToEffect           (char sigch, int bci, sun.jvm.hotspot.oops.CellTypeState[] out) {
    // Object and array
    if (sigch=='L' || sigch=='[') {
      out[0] = sun.jvm.hotspot.oops.CellTypeState.makeLineRef(bci);
      out[1] = sun.jvm.hotspot.oops.CellTypeState.bottom;
      return out;
    }
  ...
  int copyCTS                               (sun.jvm.hotspot.oops.CellTypeState[] dst, sun.jvm.hotspot.oops.CellTypeState[] src) {
    int idx = 0;
  ...
  void  initializeVars                      () {
    for (int k = 0; k < _init_vars.size(); k++)
      _state.get(((Integer) _init_vars.get(k)).intValue()).set(sun.jvm.hotspot.oops.CellTypeState.makeSlotRef(k));
  }
  ...
  //
  public GenerateOopMap(sun.jvm.hotspot.oops.Method method) {
