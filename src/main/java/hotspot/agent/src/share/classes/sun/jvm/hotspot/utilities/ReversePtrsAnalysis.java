...
public class ReversePtrsAnalysis {
  ...
  public void setHeapProgressThunk(sun.jvm.hotspot.utilities.HeapProgressThunk thunk) {
    progressThunk = thunk;
  }
  ...
  public void run() {
    ...
    VM vm = VM.getVM();
    rp = new sun.jvm.hotspot.utilities.ReversePtrs();
    vm.setRevPtrs(rp);
    ...
    markBits = new sun.jvm.hotspot.utilities.MarkBits(collHeap);
               ...
               new DefaultOopVisitor() {
                   public void doOop(OopField field, boolean isVMField) {
                     Oop next = field.getValue(getObj());
                                                ...
                                                "\" in class \"" +
                                                                                                       ik.getName().asString() + "\"");
                                                   sun.jvm.hotspot.utilities.LivenessPathElement lp = new sun.jvm.hotspot.utilities.LivenessPathElement(null, nfi);
                     rp.put(lp, next);
                     try {
      ...
      while (true) {
        ...
        currObj.iterate(new DefaultOopVisitor() {
          public void doOop(OopField field, boolean isVMField) {
            ...
            rp.put(new sun.jvm.hotspot.utilities.LivenessPathElement(currObj, field.getID()), next);
  ...
  class RootVisitor implements AddressVisitor {
    ...
    public void visitAddress(Address addr) {
      ...
      sun.jvm.hotspot.utilities.LivenessPathElement lp = new sun.jvm.hotspot.utilities.LivenessPathElement(null,
    ...
    public void visitCompOopAddress(Address addr) {
      ...
      sun.jvm.hotspot.utilities.LivenessPathElement lp = new LivenessPathElement(null,
                                        new NamedFieldIdentifier(baseRootDescription +
                                                                 " @ " + addr));
      rp.put(lp, next);
      markAndTraverse(next);
