...
package hotspot.agent.src.share.classes.sun.jvm.hotspot.debugger.posix.elf;
...
public class ELFFileParser {
     ...
     */
    public sun.jvm.hotspot.debugger.posix.elf.ELFFile parse(String filename) throws sun.jvm.hotspot.debugger.posix.elf.ELFException {
        try {
            RandomAccessFile file = new RandomAccessFile(filename, "r");
            return parse(new RandomAccessFileDataSource(file));
        } catch (FileNotFoundException e) {
            throw new sun.jvm.hotspot.debugger.posix.elf.ELFException(e);
        }
    }
     ...
     */
    public sun.jvm.hotspot.debugger.posix.elf.ELFFile parse(DataSource source) throws sun.jvm.hotspot.debugger.posix.elf.ELFException {
     ...
     */
    class ELFFileImpl implements sun.jvm.hotspot.debugger.posix.elf.ELFFile {
        private DataSource file;
        private sun.jvm.hotspot.debugger.posix.elf.ELFHeader header;
        private byte ident[] = new byte[16];

        ELFFileImpl(DataSource file) throws sun.jvm.hotspot.debugger.posix.elf.ELFException {
            this.file = file;
            int bytesRead = readBytes(ident);
            if (bytesRead != ident.length) {
                throw new sun.jvm.hotspot.debugger.posix.elf.ELFException("Error reading elf header (read " +
            ...
            if (!Arrays.equals(getMagicNumber(), ELF_MAGIC_NUMBER)) {
                    throw new sun.jvm.hotspot.debugger.posix.elf.ELFException("Bad magic number for file.");
            }

            header = new ELFHeaderImpl();
        }

        public sun.jvm.hotspot.debugger.posix.elf.ELFHeader getHeader()     { return header; }
         ...
         */
        class ELFHeaderImpl implements sun.jvm.hotspot.debugger.posix.elf.ELFHeader {
             ...
             * in memoized arrays.
             */
            ELFHeaderImpl() throws sun.jvm.hotspot.debugger.posix.elf.ELFException {
                file_type = readShort();
                arch = readShort();
                version = readInt();
                entry_point = readInt();
...
//                }
            ...
            public sun.jvm.hotspot.debugger.posix.elf.ELFSymbol getELFSymbol(String symbolName) {
                if (symbolName == null) {
                    return null;
                }

                // Check dynamic symbol table for symbol name.
                sun.jvm.hotspot.debugger.posix.elf.ELFSymbol symbol = null;
                int numSymbols = 0;
            ...
            public sun.jvm.hotspot.debugger.posix.elf.ELFSymbol getELFSymbol(long address) {
...
//            }
        ...
        class ELFSectionHeaderImpl implements ELFSectionHeader {
             ...
             */
            ELFSectionHeaderImpl(long offset) throws sun.jvm.hotspot.debugger.posix.elf.ELFException {
                seek(offset);
                name_ndx = readInt();
                type = readInt();
                flags = readInt();
            ...
            public sun.jvm.hotspot.debugger.posix.elf.ELFSymbol getELFSymbol(int index) {
                return (sun.jvm.hotspot.debugger.posix.elf.ELFSymbol)symbols[index].getValue();
            }
            ...
            public sun.jvm.hotspot.debugger.posix.elf.ELFHashTable getHashTable() {
                if (hashTable != null) {
                    return (sun.jvm.hotspot.debugger.posix.elf.ELFHashTable)hashTable.getValue();
                }
                return null;
            }
...
//        }
         ...
         */
        class ELFSymbolImpl implements sun.jvm.hotspot.debugger.posix.elf.ELFSymbol {
            ...
            ELFSymbolImpl(long offset, int section_type) throws sun.jvm.hotspot.debugger.posix.elf.ELFException {
                seek(offset);
                this.offset = offset;
                name_ndx = readInt();
                value = readInt();
        ...
        class ELFStringTableImpl implements ELFStringTable {
             ...
             */
            ELFStringTableImpl(long offset, int length) throws sun.jvm.hotspot.debugger.posix.elf.ELFException {
                seek(offset);
                data = new byte[length];
                int bytesRead = readBytes(data);
                if (bytesRead != length) {
                    throw new sun.jvm.hotspot.debugger.posix.elf.ELFException("Error reading string table (read " +
                                           bytesRead + "bytes, expected to " +
        ...
        class ELFHashTableImpl implements ELFHashTable {
            ...
            ELFHashTableImpl(long offset, int length) throws sun.jvm.hotspot.debugger.posix.elf.ELFException {
                seek(offset);
                num_buckets = readInt();
                num_chains = readInt();
             ...
             * return null. */
            public sun.jvm.hotspot.debugger.posix.elf.ELFSymbol getSymbol(String symbolName) {
//                if (symbolName == null) {
//                    return null;
//                }
//
...
//                return symbol;
        ...
        void seek(long offset) throws sun.jvm.hotspot.debugger.posix.elf.ELFException {
            try {
                file.seek(offset);
            } catch (IOException e) {
                throw new sun.jvm.hotspot.debugger.posix.elf.ELFException(e);
        ...
        int readBytes(byte[] b) throws sun.jvm.hotspot.debugger.posix.elf.ELFException {
            try {
                return file.read(b);
            } catch (IOException e) {
                throw new sun.jvm.hotspot.debugger.posix.elf.ELFException(e);
            ...
            try {
                ...
                switch (ident[NDX_ENCODING]) {
                    ...
                    case DATA_MSB:
                        ...
                        break;
                    default:
                        throw new sun.jvm.hotspot.debugger.posix.elf.ELFException("Invalid encoding.");
                }
                return val;
            } catch (IOException e) {
                throw new sun.jvm.hotspot.debugger.posix.elf.ELFException(e);
