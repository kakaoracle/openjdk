...
public class OopMapStream {
  ...
  public OopMapStream(OopMap oopMap) {
    this(oopMap, (sun.jvm.hotspot.compiler.OopMapValue.OopTypes[]) null);
  }

  public OopMapStream(OopMap oopMap, sun.jvm.hotspot.compiler.OopMapValue.OopTypes type) {
    this(oopMap, (sun.jvm.hotspot.compiler.OopMapValue.OopTypes[]) null);
    mask = type.getValue();
  }

  public OopMapStream(OopMap oopMap, sun.jvm.hotspot.compiler.OopMapValue.OopTypes[] types) {
    ...
    position = 0;
    omv = new sun.jvm.hotspot.compiler.OopMapValue();
    omvValid = false;
  }
