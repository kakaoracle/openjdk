...
public class ObjArray extends sun.jvm.hotspot.oops.Array {
  static {
  ...
  public sun.jvm.hotspot.oops.Oop getObjAt(long index) {
  ...
  public void iterateFields(OopVisitor visitor, boolean doVMFields) {
    ...
    for (int index = 0; index < length; index++) {
      ...
      if (VM.getVM().isCompressedOopsEnabled()) {
        field = new sun.jvm.hotspot.oops.NarrowOopField(new IndexableFieldIdentifier(index), offset, false);
      } else {
