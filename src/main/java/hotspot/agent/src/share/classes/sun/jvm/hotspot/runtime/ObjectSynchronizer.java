...
public class ObjectSynchronizer {
  ...
  public long identityHashValueFor(Oop obj) {
    ...
    if (mark.isUnlocked()) {
      ...
      sun.jvm.hotspot.runtime.ObjectMonitor monitor = mark.monitor();
  ...
  private static class ObjectMonitorIterator implements Iterator {
    ...
    ObjectMonitorIterator() {
      ...
      index = blockSize - 1;
      block = new sun.jvm.hotspot.runtime.ObjectMonitor(blockAddr);
    }
    ...
    public Object next() {
      ...
      index --;
      return new sun.jvm.hotspot.runtime.ObjectMonitor(addr);
    }
