...
public class MetadataField extends Field {
  ...
  public sun.jvm.hotspot.oops.Metadata getValue(sun.jvm.hotspot.oops.Oop obj) {
    return getValue(obj.getHandle());
  }
  public sun.jvm.hotspot.oops.Metadata getValue(VMObject obj) {
    return getValue(obj.getAddress());
  }
  public sun.jvm.hotspot.oops.Metadata getValue(Address addr) {
