...
public class COFFFileParser {
  ...
  public sun.jvm.hotspot.debugger.win32.coff.COFFFile parse(String filename) throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
    try {
      ...
      throw new sun.jvm.hotspot.debugger.win32.coff.COFFException(e);
    } catch (IOException e) {
      throw new sun.jvm.hotspot.debugger.win32.coff.COFFException(e);
    }
  }

  public sun.jvm.hotspot.debugger.win32.coff.COFFFile parse(DataSource source) throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
  ...
  class COFFFileImpl implements COFFFile {
    ...
    COFFFileImpl(DataSource file) throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
      this.file = file;
      initialize();
    }
    ...
    class COFFHeaderImpl implements COFFHeader {
      ...
      public OptionalHeader getOptionalHeader() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
      ...
      public sun.jvm.hotspot.debugger.win32.coff.SectionHeader getSectionHeader(int index) {
        // NOTE zero-basing of index
        return (sun.jvm.hotspot.debugger.win32.coff.SectionHeader) sectionHeaders[index - 1].getValue();
      }
      public sun.jvm.hotspot.debugger.win32.coff.COFFSymbol getCOFFSymbol(int index)    {
        return (sun.jvm.hotspot.debugger.win32.coff.COFFSymbol) symbols[index].getValue();
      }
      ...
      int rvaToFileOffset(int rva) {
        ...
        for (int i = 1; i <= getNumberOfSections(); i++) {
          sun.jvm.hotspot.debugger.win32.coff.SectionHeader sec = getSectionHeader(i);
        ...
        throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("Unable to find RVA 0x" +
      ...
      class OptionalHeaderStandardFieldsImpl implements OptionalHeaderStandardFields {
        ...
        public int getBaseOfData() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          if (isPE32Plus) {
            throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("Not present in PE32+ files");
          }
          return baseOfData;
        }
      }
      ...
      class OptionalHeaderDataDirectoriesImpl implements OptionalHeaderDataDirectories {
        ...
        OptionalHeaderDataDirectoriesImpl(int offset,
          ...
          exportDirectoryTable = new MemoizedObject() {
              public Object computeValue() {
                sun.jvm.hotspot.debugger.win32.coff.DataDirectory dir = getExportTable();
          ...
          debugDirectory = new MemoizedObject() {
              public Object computeValue() {
                sun.jvm.hotspot.debugger.win32.coff.DataDirectory dir = getDebug();
                if (dir.getRVA() == 0 || dir.getSize() == 0) {
                  return null;
                }
        ...
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getExportTable() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(0)].getValue();
        }
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getImportTable() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(1)].getValue();
        }
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getResourceTable() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(2)].getValue();
        }
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getExceptionTable() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(3)].getValue();
        }
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getCertificateTable() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(4)].getValue();
        }
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getBaseRelocationTable() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(5)].getValue();
        }
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getDebug() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(6)].getValue();
        }
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getArchitecture() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(7)].getValue();
        }
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getGlobalPtr() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(8)].getValue();
        }
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getTLSTable() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(9)].getValue();
        }
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getLoadConfigTable() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(10)].getValue();
        }
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getBoundImportTable() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(11)].getValue();
        }
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getImportAddressTable() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(12)].getValue();
        }
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getDelayImportDescriptor() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(13)].getValue();
        }
        public sun.jvm.hotspot.debugger.win32.coff.DataDirectory getCOMPlusRuntimeHeader() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          return (sun.jvm.hotspot.debugger.win32.coff.DataDirectory) dataDirectories[checkIndex(14)].getValue();
        }
        ...
        private int checkIndex(int index) throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          if ((index < 0) || (index >= dataDirectories.length)) {
            throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("Directory " + index + " unavailable (only " +
      ...
      class DebugDirectoryImpl implements DebugDirectory {
        ...
        DebugDirectoryImpl(int offset, int size) {
          ...
          if ((size % DEBUG_DIRECTORY_ENTRY_SIZE) != 0) {
            throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("Corrupt DebugDirectory at offset 0x" +
      ...
      class DebugDirectoryEntryImpl implements DebugDirectoryEntry, DebugTypes {
        ...
        public sun.jvm.hotspot.debugger.win32.coff.DebugVC50 getDebugVC50() {
          ...
          } catch (sun.jvm.hotspot.debugger.win32.coff.COFFException e) {
            e.printStackTrace();
          }
          return null;
        }
      ...
      class DebugVC50Impl implements DebugVC50, DebugVC50TypeLeafIndices {
        ...
        private void verify() {
          ...
          throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("Did not find NB11 signature at end of debug info");
        }
        ...
        class DebugVC50SubsectionDirectoryImpl
          ...
          public DebugVC50Subsection getSubsection(int i) {
            ...
            default:
              throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("Unknown section type " + ssType);
            }
          }
        }
        ...
        class DebugVC50TypeIteratorImpl implements DebugVC50TypeIterator,
          ...
          private int typeStringLength() {
            ...
            case LF_COBOL0:
            case LF_COBOL1:    throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("COBOL symbols unimplemented");
            ...
            case LF_OEM:       throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("OEM symbols unimplemented");
            ...
            case LF_DIMCONLU:
            case LF_DIMVARU:
            case LF_DIMVARLU:  throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("LF_DIMCONU, LF_DIMCONLU, LF_DIMVARU, and LF_DIMVARLU unsupported");
            case LF_REFSYM: {
            ...
            case LF_VARSTRING:  throw new RuntimeException("Unexpected numeric leaf " + typeStringLeaf +
                                                           "in type string");
            default:
              throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("Unrecognized leaf " + typeStringLeaf + " in type string at offset " +
                                      typeStringOffset);
            }
          }
        ...
        private String readLengthPrefixedStringAt(int absoluteOffset) {
          ...
          if (numRead != len) {
            throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("Error reading length prefixed string in symbol at offset " +
                                    absoluteOffset);
          }
          try {
            return new String(res, US_ASCII);
      ...
      class SectionHeaderImpl implements SectionHeader {
        ...
        public SectionHeaderImpl(int offset) throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          seek(offset);
          ...
          if (numRead != 8) {
            throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("Error reading name of section header at offset " + offset);
          }
          if (tmpName[0] == (byte) '/') {
            ...
            try {
              ...
              throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("Error parsing string table index of name of section header " +
                                      "at offset " + offset);
            } catch (UnsupportedEncodingException e) {
              throw new sun.jvm.hotspot.debugger.win32.coff.COFFException(e);
            }
      ...
      class COFFSymbolImpl implements COFFSymbol, COFFSymbolConstants {
        ...
        public COFFSymbolImpl(int offset) throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
          this.offset = offset;
          seek(offset);
          ...
          int numRead = readBytes(tmpName);
          if (numRead != 8) {
            throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("Error reading name of symbol at offset " + offset);
          }
          if ((tmpName[0] == 0) &&
              (tmpName[1] == 0) &&
              (tmpName[2] == 0) &&
        ...
        public sun.jvm.hotspot.debugger.win32.coff.AuxBfEfRecord getAuxBfEfRecord() {
          return (sun.jvm.hotspot.debugger.win32.coff.AuxBfEfRecord) auxBfEfRecord.getValue();
        }
        ...
        public sun.jvm.hotspot.debugger.win32.coff.AuxFileRecord getAuxFileRecord() {
          return (sun.jvm.hotspot.debugger.win32.coff.AuxFileRecord) auxFileRecord.getValue();
        }
      ...
      class AuxFileRecordImpl implements AuxFileRecord {
        ...
        AuxFileRecordImpl(int offset) {
          ...
          int numRead = readBytes(tmpName);
          if (numRead != 18) {
            throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("Error reading auxiliary file record at offset " + offset);
          }
          try {
      ...
      class StringTable {
        ...
        StringTable(int offset) {
          ...
          if (numBytesRead != data.length) {
            throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("Error reading string table (read " +
        ...
        String getAtOffset(int offset) {
          ...
          if (i < 0) {
            throw new sun.jvm.hotspot.debugger.win32.coff.COFFException("No string found at file offset " + offset);
          }
          return strings[i].str;
        }
      }
    ...
    byte readByteAt(long offset) throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
      seek(offset);
      return readByte();
    }
    ...
    byte readByte() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
      try {
        ...
        throw new sun.jvm.hotspot.debugger.win32.coff.COFFException(e.toString() + " at offset 0x" +
                                Long.toHexString(filePos), e);
      }
    }

    int readBytesAt(long offset, byte[] b) throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
      seek(offset);
      return readBytes(b);
    }

    int readBytes(byte[] b) throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
      try {
        return file.read(b);
      } catch (IOException e) {
        throw new sun.jvm.hotspot.debugger.win32.coff.COFFException(e.toString() + " at offset 0x" +
    ...
    short readShortAt(long offset) throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
      seek(offset);
      return readShort();
    }
    ...
    int readIntAt(long offset) throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
      seek(offset);
      return readInt();
    }
    ...
    long readLongAt(long offset) throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
      seek(offset);
      return readLong();
    }
    ...
    String readCString() throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
      List data = new ArrayList();
      byte b = 0;
      while ((b = readByte()) != 0) {
        data.add(new Byte(b));
    ...
    void seek(long offset) throws sun.jvm.hotspot.debugger.win32.coff.COFFException {
      try {
        filePos = offset;
        file.seek(offset);
      } catch (IOException e) {
