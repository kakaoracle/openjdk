...
public class ScopeDesc {
  ...
  private ScopeDesc(sun.jvm.hotspot.code.NMethod code, int decodeOffset, List objects, boolean reexecute) {
    this.code = code;
  ...
  public ScopeDesc(sun.jvm.hotspot.code.NMethod code, int decodeOffset, int objectDecodeOffset, boolean reexecute) {
    this.code = code;
    this.decodeOffset = decodeOffset;
