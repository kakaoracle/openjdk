...
public interface TypeDataBase {
  ...
  public sun.jvm.hotspot.types.Type lookupType(String cTypeName);
  ...
  /** For simplicity of the initial implementation, this is not
      ...
      not found. */
  public sun.jvm.hotspot.types.Type lookupType(String cTypeName, boolean throwException);
  ...
  /** <P> This is an experimental interface emulating C++'s run-time
      ...
      inheritance. </P> */
  public boolean addressTypeIsEqualToType(Address addr, sun.jvm.hotspot.types.Type type);
  ...
  /** Helper routine for guessing the most derived type of a
      ...
      found. */
  public sun.jvm.hotspot.types.Type guessTypeForAddress(Address addr);

  /** Helper routine for guessing the most derived type of a
      polymorphic C++ object. Requires a baseType that must be virtual
      so that lookup can be performed without false positives */
  public sun.jvm.hotspot.types.Type findDynamicTypeForAddress(Address addr, Type baseType);
