...
public interface ProcDebugger extends JVMDebugger {
  ...
  public sun.jvm.hotspot.debugger.proc.ProcAddress readAddress(long address) throws DebuggerException;
  public sun.jvm.hotspot.debugger.proc.ProcAddress readCompOopAddress(long address) throws DebuggerException;
  public sun.jvm.hotspot.debugger.proc.ProcAddress readCompKlassAddress(long address) throws DebuggerException;
