...
package hotspot.agent.src.share.classes.sun.jvm.hotspot.debugger.proc.amd64;
...
public class ProcAMD64ThreadFactory implements ProcThreadFactory {
    ...
    public ThreadProxy createThreadWrapper(Address threadIdentifierAddr) {
        return new sun.jvm.hotspot.debugger.proc.amd64.ProcAMD64Thread(debugger, threadIdentifierAddr);
    }
