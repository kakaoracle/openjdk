...
package hotspot.agent.src.share.classes.sun.jvm.hotspot.tools;
...
public class JInfo extends sun.jvm.hotspot.tools.Tool {
    public JInfo() {
        super();
    }
    ...
    public void run() {
        sun.jvm.hotspot.tools.Tool tool = null;
        switch (mode) {
        case MODE_FLAGS:
            printVMFlags();
            return;
        case MODE_SYSPROPS:
            ...
            break;
        case MODE_BOTH: {
            tool = new sun.jvm.hotspot.tools.Tool() {
                    public void run() {
